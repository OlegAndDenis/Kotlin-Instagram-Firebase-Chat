...
class CurrentUserItem(val text: String, private val timestamp: Long) : Item<ViewHolder>() {
...
class CompanionUserItem(val text: String, private val userPhoto: String?, private val timestamp: Long) :
    Item<ViewHolder>() {
    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.run {
...
class CurrentUserItemLight(val text: String) : Item<ViewHolder>() {
    override fun bind(viewHolder: ViewHolder, position: Int) {
...
class CompanionUserItemLight(val text: String) : Item<ViewHolder>() {
    override fun bind(viewHolder: ViewHolder, position: Int) {
